...
//create habit  and save the habits in the database
        ...
        await habit.deleteOne({habit:req.params.id});  
            if(req.xhr){
                return res.status(200).json({
                    ...
                    message:"Habit deleted from database!"
                });
            }
            return res.redirect('back');
...
// Get habits From the database for details page
module.exports.details = async function(req,res){
    ...
    // Find the Date and Return the string Date for details page
    function getD(n) {
        let d = new Date();
